...
public class BetterBishopMovesCalculator extends PieceMovesCalculator {
    ...
    public BetterBishopMovesCalculator(ChessBoard board, ChessPosition startPosition, ChessPiece piece) {
